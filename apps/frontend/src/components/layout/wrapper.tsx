    ...
    <>
      ...
      {session.status === 'authenticated' && (
        <Link
          ...
          className="cursor-pointer text-white text-[20px] bg-gradient-to-b from-[#ff0000] to-[#970000] group-hover:from-[#FCFF63] group-hover:to-[#FFDD29] text-center p-[3px] font-bebas"
        >
